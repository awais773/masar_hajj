/*
-----------------------------------------
    : Custom - Chartistjs Charts js :
-----------------------------------------
*/
"use strict";
$(document).ready(function() {
    /* -- Chartistjs - Simple Line Chart -- */
    new Chartist.Line('#chartist-simple-line', {
    ...
    new Chartist.Line('#chartist-only-holes-in-data', {
    ...
    new Chartist.Line('#chartist-line-scatter-diagram', data, options, responsiveOptions);
    ...
    new Chartist.Line('#chartist-bi-polar-line', {
      labels: [1, 2, 3, 4, 5, 6, 7, 8],
      series: [
        [1, 2, 3, 1, -2, 0, 1, 0],
        [-2, -1, -2, -1, -2.5, -1, -2, -1],
    ...
    var chart = new Chartist.Line('#chartist-advanced-smil-animations', {
      ...
      var chart = new Chartist.Line('#chartist-svg-path-animations', {
      ...
      var chart = new Chartist.Line('#chartist-line-interpolation-smoothing', {
        labels: [1, 2, 3, 4, 5],
        series: [
          [1, 5, 10, 0, 1],
          [10, 15, 0, 1, 2]
      ...
      var chart = new Chartist.Line('#chartist-series-overrides', {
        labels: ['1', '2', '3', '4', '5', '6', '7', '8'],
        series: [{
          name: 'series-1',
      ...
      new Chartist.Bar('#chartist-bi-polar-chart', data, options);
      ...
      new Chartist.Bar('#chartist-overlapping-bars-on-moblie', data, options, responsiveOptions);
      /* -- Chartistjs - Add Peak Circles Using The Draw Events Chart -- */
      var chart = new Chartist.Bar('#chartist-add-peak-circles', {
        labels: ['W1', 'W2', 'W3', 'W4', 'W5', 'W6', 'W7', 'W8', 'W9', 'W10'],
        series: [
          [1, 2, 4, 8, 6, -2, -1, -4, -6, -2]
        ]
      ...
      new Chartist.Bar('#chartist-multi-line-lables', {
      ...
      new Chartist.Bar('#chartist-extreme-responsive-configuration', {
      ...
      new Chartist.Bar('#chartist-label-placement', {
      ...
      new Chartist.Pie('#chartist-pie-chart-with-custom-labels', data, options, responsiveOptions);
      ...
      var chart = new Chartist.Pie('#chartist-animating-donut-with-svg-animate', {
      ...
      new Chartist.Pie('#chartist-donut-fill-rather-chart', {
        series: [45, 35, 20]
      }, {
        donut: true,
        donutWidth: 40,
