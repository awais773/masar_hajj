                    ...
                    <div class="col-md-8 col-lg-8">
                        <div class="breadcrumb-list">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ __('admin.edit_admin') }}</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h5 class="card-title">{{ trans('admin.edit_admin');}}</h5>
                            </div>
                            <div class="card-body">
                                <form action="{{route('company.admin.update',$admin->id)}}" method="POST"  enctype="multipart/form-data">
                                @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <input type="text" class="form-control" id="password" name="password" required  value="{{$admin->password}}">
                                        </div>
                                        <div class="form-group col-6">
