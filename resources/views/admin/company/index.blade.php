                                       ...
                                       @endphp
                                        @foreach ($companies as $company)
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{route('admin.company.user',$company->id)}}" class="btn amazing-success-btn" target="_blank" style="cursor: pointer;">{{count($company->companyusers)}}</a></td>
                                                <td><a href="#" class="btn amazing-success-btn" target="_blank" style="cursor: pointer;">{{count($company->companyadmins)}}</a></td>
                                                ...
                                                <td style="white-space: nowrap; width: 15%;">
                                                    ...
                                                    <div class="btn-group btn-group-sm" style="float: none;">
                                                                ...
                                                                <a href="{{route('admin.company.edit',$company->id)}}" class="amazing-edit-btn" style="float: none;"><span class="ti-pencil align-middle"></span></a> &nbsp;&nbsp;
                                                            ...
                                                            <button type="button" class="amazing-delete-btn" data-href="{{route('admin.company.delete',$company->id)}}" data-toggle="modal" data-target="#deleteData"> <span class="ti-trash align-middle"></span></button>
